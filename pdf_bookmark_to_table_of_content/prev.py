...
doc_main = fitz.open("List of Staff.pdf")
doc_add = fitz.open("country.pdf")
...
toc_page_idx = 1
doc_main.insert_page(toc_page_idx, width=paper_width, height=paper_height)
...
# print(doc_main.page_count)
# doc_main.delete_pages(from_page = 6, to_page=doc_main.page_count-1)

# doc_main.save("newpdf.pdf")
